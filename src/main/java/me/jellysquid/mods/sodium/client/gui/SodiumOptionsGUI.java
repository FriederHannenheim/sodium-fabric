...
public class SodiumOptionsGUI extends Screen {
    ...
    public boolean keyPressed(int keyCode, int scanCode, int modifiers) {
        if (keyCode == GLFW.GLFW_KEY_P && (modifiers & GLFW.GLFW_MOD_SHIFT) != 0) {
            MinecraftClient.getInstance().method_29970(new VideoOptionsScreen(this.prevScreen, MinecraftClient.getInstance().options));
    ...
    @Override
    public void onClose() {
        this.client.method_29970(this.prevScreen);
    }
}
